    ...
    return (
        <>
                            ...
                            <Card>
                             ...
                             <Card>
                                ...
                                <CardContent className="space-y-2 text-center text-muted-foreground">
                                    ...
                                    <Button variant="secondary" size="sm" onClick={() => setIsHistoryModalOpen(true)}>View My Book History</Button>
                                </CardContent>
                            </Card>
                        </div>
                        <Card>
            ...
            <AlertDialog open={isHistoryModalOpen} onOpenChange={setIsHistoryModalOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle className="font-headline text-2xl">My Book History</AlertDialogTitle>
                        <AlertDialogDescription>
                            This feature is coming soon! You'll be able to see your full borrowing history, manage your wishlist, and rate the books you've read, all from one place.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogAction onClick={() => setIsHistoryModalOpen(false)}>Close</AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
        </>
